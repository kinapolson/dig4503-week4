...
1. Have a coding environment installed on your computer
2. Download the project from GitHub
3. Open the project folder on your computer
4. Install any required files.
5. Start the server
6. Open Claude and type “/mcp” and select the tools.
7. Add or connect the Local File Reader
8. Use the tool to access text files from the selected directory.

Usages:
-Read notes.txt file using Local File Reader tool to summarize
-Access data.txt file using Local File Reader tool to organize data
